export default {
    ...
    questions: {
        title: "Questions",
        subHeading: "Of course, as the owner of a four-legged friend, you have many questions. Here we have collected the most common questions with answers. Should the answer to your question not be available, you are welcome to contact us here!",
    ...
    about: {
        ...
        firstParagraph: "You will find the kennel on a large family farm just 5 minutes from the center of Helsingborg. The yard has large fenced outdoor areas where your four-legged friend can run free with other four-legged friends. The indoor part was renovated in 2020 and there are both social and individual spaces, all to make your dog feel safe.",

        secondParagraph: "Hundkojan ser till att din vovve både får lugn och ro, aktivering, stimulans och härligt umgänge med andra hundar – så att du kan göra det du behöver göra!",
